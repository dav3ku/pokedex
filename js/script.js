          ...
          const element = `
              <div class="col-sm-4 col-md-3 col-lg-2">
                <div class="card" id="pokemon-card" data-bs-toggle="modal" data-bs-target="#pokemon${data.id}">
                  <img src="${data.sprites.other.dream_world.front_default}" class="card-img-top" alt="${data.id} - ${data.name}">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-sm-1 col-md-4">
                          <img src="${data.sprites.other.dream_world.front_default}" class="img-modal" alt="${data.id} - ${data.name}">
                        </div>
